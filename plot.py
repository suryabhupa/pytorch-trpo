...
def main(filename, gae, qe, freq, limit):
    ...
    if gae:
        ...
        plt.plot(eps,savgol_filter(var[:,0], freq, 5), 'go', label='0-step')
        plt.plot(eps,savgol_filter(var[:,1], freq, 5), 'go', label='1-step')
        plt.plot(eps,savgol_filter(var[:,2], freq, 5), 'go', label='2-step')
        plt.plot(eps,savgol_filter(var[:,3], freq, 5), 'go', label='3-step')
        plt.plot(eps,savgol_filter(var[:,4], freq, 5), 'go', label='10-step')
        plt.plot(eps,var[:,0], 'go', alpha=0.15)
        plt.plot(eps,var[:,1], 'go', alpha=0.15)
        plt.plot(eps,var[:,2], 'go', alpha=0.15)
        plt.plot(eps,var[:,3], 'go', alpha=0.15)
        plt.plot(eps,var[:,4], 'go', alpha=0.15)
    elif qe:
        plt.figure(figsize=(16, 6))
        ax = plt.subplot(121)
        ax.set_title('variance')
        plt.plot(eps[:limit],savgol_filter(var[:limit,0], freq, 5), 'bo', label='0-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,1], freq, 5), 'bo', label='1-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,2], freq, 5),'bo', label='2-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,3], freq, 5),'bo', label='3-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,4], freq, 5),'bo', label='10-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,5], freq, 5),'bo', label='qvalue')
        # plt.plot(eps,savgol_filter(var[:,5], 101, 5),label='qfirst')
        # plt.plot(eps,savgol_filter(var[:,6], 101, 5),label='qsecond')
        plt.plot(eps[:limit],var[:limit,0], 'bo', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,1], 'bo', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,2], 'bo', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,3], 'bo', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,4], 'bo', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,5], 'bo', alpha=0.15)
        ...
        ax = plt.subplot(121)
        ax.set_title('variance')
        plt.plot(eps[:limit],savgol_filter(var[:limit,0], freq, 5), 'ro', label='0-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,1], freq, 5), 'ro', label='1-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,2], freq, 5),'ro', label='2-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,3], freq, 5),'ro', label='3-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,4], freq, 5),'ro', label='10-step')
        plt.plot(eps[:limit],savgol_filter(var[:limit,5], freq, 5),'ro', label='qvalue')
        plt.plot(eps[:limit],savgol_filter(var[:limit,6], freq, 5),'ro', label='qevalue')
        plt.plot(eps[:limit],var[:limit,0], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,1], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,2], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,3], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,4], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,5], 'ro', alpha=0.15)
        plt.plot(eps[:limit],var[:limit,6], 'ro', alpha=0.15)
    else:
        plt.figure(figsize=(16, 6))
        ax = plt.subplot(121)
        ax.set_title('variance')
